...
#define EncoderDireito_Pin GPIO_PIN_3
#define EncoderDireito_GPIO_Port GPIOA
#define EncoderDireito_EXTI_IRQn EXTI3_IRQn
#define EncoderEsquerdo_Pin GPIO_PIN_4
#define EncoderEsquerdo_GPIO_Port GPIOA
#define EncoderEsquerdo_EXTI_IRQn EXTI4_IRQn
#define Buzzer_Pin GPIO_PIN_5
#define Buzzer_GPIO_Port GPIOA
#define SensorFrenteTrigger_Pin GPIO_PIN_6
